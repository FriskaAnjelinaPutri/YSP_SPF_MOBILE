  ...
  static Future<Map<String, dynamic>?> login(
    ...
    try {
      ...
      if (response.statusCode == 200 && data != null) {
        ...
        print(
          "❌ Login gagal: ${response.statusCode} - ${data?['message'] ?? response.body}",
        );
        return null;
      }
    } catch (e) {
  ...
  static Future<Map<String, dynamic>?> getKaryawanProfile(String token) async {
    try {
      ...
      if (response.statusCode == 200 && data != null) {
        ...
        print(
          "❌ Gagal ambil profil: ${response.statusCode} - ${data?['message'] ?? response.body}",
        );
        return null;
      }
    } catch (e) {
  ...
  static Future<bool> updateProfile(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(
          "❌ Update gagal: ${response.statusCode} - ${resData?['message'] ?? response.body}",
        );
        return false;
      }
    } catch (e) {
  ...
  static Future<bool> updatePassword(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(
          "❌ Update password gagal: ${response.statusCode} - ${data?['message'] ?? response.body}",
        );
        return false;
      }
    } catch (e) {
